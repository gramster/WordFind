...
class ListSource
{
  public:
    ...
    virtual Boolean GetItem(Int16 itemnum, Char* buf, UInt16 buflen, Char* *resource_strings) = 0;
    virtual ~ListSource();
};
...
#define LISTHANDLER(lid) static void ListDrawEventHandler(Int16 idx, RectanglePtr bounds, Char **data) \
				{ (void)data; Application::Instance()->DrawListItem(lid, idx, bounds, data); } \
...
class List : public Widget
{
  ...
  public:
    ...
    List(class Form *owner_in, UInt16 id_in, ListSource *source_in);
    
    // Draw handler. data is the static list resource text, idx the index, and bounds the location and extent
    
    void DrawItem(Int16 idx, RectanglePtr bounds, Char* *resource_strings) const;
...
//
// A FixedListSource get the items from static strings in the
// list resource. In this case we just use the text provided
...
class FixedListSource : public ListSource
{
  ...
  public:
    ...
    virtual Boolean GetItem(Int16 itemnum, Char* buf, UInt16 buflen, Char* *resource_strings);
...
class Application
{
  ...
  public:
    ...
    void DrawListItem(UInt16 lidx, Int16 idx, RectanglePtr bounds, Char* *data);
#endif
